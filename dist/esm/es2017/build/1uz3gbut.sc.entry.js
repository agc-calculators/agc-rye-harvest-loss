...
class AgcRyeHarvestLoss {
    ...
    render() {
        return (h("div", null,
            h("form", { onSubmit: (e) => e.preventDefault(), ref: c => this.form = c, "data-wizard": "agc-rye-harvest-loss", "data-wizard-mode": this.mode, class: "agc-wizard" },
                h("slot", null),
                h("section", { "data-wizard-section": "0" },
                    h("div", { class: "agc-wizard__field" },
                        h("label", { "data-i18n": "fields.kernel-count" }, "Kernel Count"),
                        h("input", { name: "kernelCount", type: "number", required: true, min: "0", step: "1" }),
                        h("p", { class: "agc-wizard__validation-message", "data-i18n": "validation.kernel-count.required", "data-validates": "kernelCount" }, "Please enter a whole number of zero or greater."),
                        h("p", { "data-i18n": `hints.kernel-count` }, "\u2BA4 Enter the number of rye kernels counted on the ground within the specified area.")),
                ...
                h("section", { "data-wizard-section": "1" },
                    h("div", { class: "agc-wizard__field" },
                        ...
                        h("p", { "data-i18n": `hints.loss-area` }, "\u2BA4 Enter the area in square feet that was used to count rye kernels on the ground.")),
    ...
    showResults() {
        let kernelCount = parseInt(this.form.querySelector('[name="kernelCount"').value);
    ...
    static get is() { return "agc-rye-harvest-loss"; }
