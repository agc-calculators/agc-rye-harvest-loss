...
class AgcRyeHarvestLossInputs {
    ...
    render() {
        return (h("section", { "data-wizard-results": true, ref: c => (this.section = c) },
            ...
            h("div", { style: { display: this.ready ? "block" : "none" } }, this.data && (h("ul", { class: "agc-results" },
                h("li", null,
                    h("h2", { "data-i18n": "results.kernel-count" }, "Kernel Count"),
                    h("span", { class: "agc-results__value" }, this.data["kernelCount"])),
                h("li", null,
    ...
    static get is() { return "agc-rye-harvest-loss-inputs"; }
...
export { AgcRyeHarvestLossInputs };
